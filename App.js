...
// 3. delete the constant variables declared below as they are placeholders


// TODO: delete the constant variables data and location declared below as they are placeholders
  ...
  const searchLocation = (event) => {
    if (event.key === 'Enter') {
      ...
      // TODO: once the data has been set, the location can be reset using the location setter function
    }
  }
